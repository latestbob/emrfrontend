...
import { getAppointments, getUniqueAppointment, updateAppointment } from "../services/appointment";
                          ...
                          <div className="">
                            ...
                            <div className="flex items-center">
                                <input
                                    ...
                                    className="mr-2"
                                    onChange={handleVisitTypeChange}
                                    checked={visitType === "First visit after discharge"}
                                />
                            ...
                            <div className="flex items-center">
                                <input
                                    ...
                                    className="mr-2"
                                    onChange={handleVisitTypeChange}
                                    checked={visitType === "Package consultation"}
                                />
