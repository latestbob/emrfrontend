        ...
        <div className="flex-1 bg-gray-100 min-h-screen">
          ...
          <main className="p-6 bg-gray-100 flex-1">
            <div className="flex bg-cyan-900 px-10 py-5 justify-between items-center rounded">
              ...
              {user && ["Super Admin", "Receptionist", "Administrator"].includes(
                user.role
              ) && (
                <div className="buttondiv">
                  <Link
                    to="/register-patient"
                    className="text-white bg-[#f36e25] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2"
                  >
                    <span className="pr-4">
                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                      ...
                      <tbody>
                        ...
                        <label  className="sr-only">checkbox</label> */}
                                ...
                                <td className="px-6 py-4">{patient.title}</td>
                                <td
                                  scope="row"
